...
.road-pass-brand{{display:flex;align-items:center;gap:2.2cqw;margin-bottom:1.2cqw}}.road-pass-brand img{{width:13.5cqw;height:6.2cqw;object-fit:contain;object-position:top left;transform:translateY(-.8cqw)}}.road-pass-brand b{{font-size:clamp(19px,4.15cqw,38px);line-height:1.12;color:#081521}}
