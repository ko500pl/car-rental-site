...
.road-pass-body::after{{content:"";position:absolute;z-index:-1;inset:0;background:url('georgian-heritage-watermark.png') center/100% 100% no-repeat;opacity:.9;filter:brightness(.88) contrast(1.32) saturate(1.08);pointer-events:none}}
.road-pass-identity{{min-width:0;padding-inline-end:5%;border-inline-end:2px dotted #98a6b4;background:linear-gradient(90deg,rgba(255,255,255,.82) 0%,rgba(255,255,255,.64) 68%,rgba(255,255,255,.12) 100%);border-radius:8px 0 0 8px}}
