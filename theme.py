...
.road-pass-body::after{{content:"";position:absolute;z-index:-1;inset:0;background:url('georgian-heritage-watermark.png') center/100% 100% no-repeat;opacity:.48;pointer-events:none}}
