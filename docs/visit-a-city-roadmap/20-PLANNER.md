...
## მიმდინარე პროგრესი — 2026-08-28

- ერთიან რუკა-დამგეგმავში origin, დღეები/საათები, ფილტრები, არჩეული ობიექტები და სტანდარტული ტური ერთ state-ში სინქრონდება; URL-ით გაზიარება ინახავს ზუსტ coordinate-ს.
- საწყისი წერტილი მუშაობს მრავალენოვანი ძიებით, GPS-ითა და რუკაზე არჩევით; სტანდარტულ ტურს უკვე შეუძლია განსაზღვროს საკუთარი origin. დარჩენილია draggable pin-ის სრულყოფა და migration-ის დასრულება.
- route line რეალური გზებით იგება, ავტომატური scroll გამორთულია, ხოლო არჩეული ობიექტები ფილტრის შეცვლისას აღარ იკარგება.
- შესაძლო/დაუტევადი ადგილები ცალკე მდგომარეობით ჩანს: დაუტევადი ნაცრისფერია და აჩვენებს რამდენი დრო აკლია; დროის გათავისუფლების შემდეგ ხელახლა აქტიურდება.
- სტანდარტული ტური popup-იდან იმავე გვერდზე იტვირთება, ირჩევს waypoint-ებს და რუკა ერგება მარშრუტს. რაჭის 2-დღიანი ტური იწყება ქუთაისიდან და იყენებს 12-საათიან დღიურ ბიუჯეტს.
- დარჩენილია სრული დღიური event timeline, opening hours, სასტუმრო/overnight, reset-to-template და mobile tabs.
