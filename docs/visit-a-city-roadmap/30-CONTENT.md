...
**მიმდინარე შედეგი (2026-08-28):** 267 ობიექტი/11 რეგიონი შემოწმებულია, schema validation დასრულდა 0 error-ითა და 0 warning-ით. 264 მთავარი ფოტოდან 156 ზუსტად იდენტიფიცირებულია; 3 ობიექტს ჯერ აკლია ზუსტი მთავარი ფოტო, ხოლო 230 მედია დაბალი გარჩევადობისაა. ამიტომ ამოცანა რჩება მიმდინარე სტატუსში. დეტალები: `reports/ATTRACTION_CONTENT_AUDIT.md` და `reports/PHOTO_RIGHTS_NEEDED.md`.
